#pragma checksum "C:\Users\k2\Desktop\Lessons\TestProject\TestProject\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e5ac0c4e6a0cf76287cb751bef063712b760c7a4"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e5ac0c4e6a0cf76287cb751bef063712b760c7a4", @"/Views/Home/Index.cshtml")]
     ...
     ");
            WriteLiteral(@"                   </div>
                    ...
                    <div class=""list-group contact-group"">
                      ...
                      ");
            WriteLiteral(@"                  <i class=""fa fa-map-marker""></i> San Francisco, California, United States
                                ...
                                <div class=""media-body"">
                                    ...
                                    <div class=""media-content"">
                                        ...
                                        <ul class=""list-unstyled"">
                                            <li><i class=""fa fa-skype""></i> jdoe.doe</li>
                                            <li>");
            WriteLiteral(@"<i class=""fa fa-mobile""></i> +63 912 212 2451</li>
                                            <li><i class=""fa fa-envelope-o""></i> joedoe@email.com</li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <a href=""#"" class=""list-group-item"">
                            <div class=""media"">
                                ...
                                <div class=""media-body"">
                                    <h4 class=""media-heading"">John Doe <small>Software Engineer at Facebook, Inc.</small></h4>
                                    <div class=""media-content"">
                                        <i class=""fa fa-map-marker""></i> San Fran");
            WriteLiteral(@"cisco, California, United States
                                        <ul class=""list-unstyled"">
                                            <li><i class=""fa fa-skype""></i> jdoe.doe</li>
                                            <li><i class=""fa fa-mobile""></i> +63 912 212 2451</li>
                                            <li><i class=""fa fa-envelope-o""></i> joedoe@email.com</li>
                        ...
                        <a href=""#"" class=""list-group-item"">
                            <div class=""media"">
                                ...
                                <div class=""media-body"">
                                 ");
            WriteLiteral(@"   <h4 class=""media-heading"">John Doe <small>Software Engineer at Facebook, Inc.</small></h4>
                                    <div class=""media-content"">
                                        <i class=""fa fa-map-marker""></i> San Francisco, California, United States
                                        <ul class=""list-unstyled"">
                                            <li><i class=""fa fa-skype""></i> jdoe.doe</li>
                ...
                ");
            WriteLiteral(@"            <li class=""disabled""><a href=""#""><i class=""fa fa-angle-left""></i></a></li>
                ...
                <div class=""modal-dialog"">
                    <div class=""modal-content animated fadeOutRight"">
                        <div class=""modal-body"">
                          ...
                          ");
            WriteLiteral(@"      <div class=""col-md-12 padding-bottom-8 padding-top-8 bg-silver"">
                                    ...
                                    <div class=""contact-add-content"">
                                        <form class=""form-horizontal tabular-form margin-top-10"">
                                            <div class=""form-group"">
                                                ...
                                                <div class=""col-");
            WriteLiteral(@"sm-10 tabular-border"">
